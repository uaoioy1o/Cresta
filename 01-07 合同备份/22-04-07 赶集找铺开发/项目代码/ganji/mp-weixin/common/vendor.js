...
var _tags = __webpack_require__(/*! @dcloudio/vue-cli-plugin-uni/packages/postcss/tags */ 13);

var baseUrl = "http://zdcs.wuhanwanxin.cn/api";
var ganjiBase = "http://api.gjzhaopu.top:8089/api";
...
var _default = function _default(params) {
  ...
  return new Promise(function (resolve, reject) {
    wx.request({
      header: {
        "Content-Type": params.isHeader ? "multipart/form-data" : "application/json"
      },
      url: params.isGanji ? ganjiBase + params.url : baseUrl + params.url,
      data: params.data || {},
...
/***/ 67:
/*!*******************************************************!*\
  !*** ./src/components/region-picker/region-picker.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
