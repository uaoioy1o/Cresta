...
}(), _wepy = require("./../../npm/wepy/lib/wepy.js"), _wepy2 = _interopRequireDefault(_wepy), _tip = require("./../../utils/tip.js"), _tip2 = _interopRequireDefault(_tip), _idcardVerify = require("./../../utils/idcardVerify.js"), _util = require("./../../utils/util.js"), _api = require("./../../api/api.js"), VIP = function(e) {
    function t() {
        var e, i, n, a;
        ...
        n.config = {
            ...
            submit: function() {
                var e = (this.num, this.amount, this.id, this.shop_type, this.dataSource), t = this.currentId;
                this.selectedCoupon;
                if (!this.isChecked) return _tip2.default.error("请阅读VIP服务协议"), !1;
                (0, _api.buyVip)({
                    vip_type: e[t].id
                }).then(function(e) {
...
Page(require("./../../npm/wepy/lib/wepy.js").default.$createPage(VIP, "pages/mine/vip"));